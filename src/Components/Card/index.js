    ...
    <>
      ...
      >
        <h2
          ...
          className="mb-0 text-[#111111] font-[700] text-[14px] md:text-[18px]"
        >
          {title}
        </h2>
        <div
        ...
        <div className="flex justify-between items-center">
          <h4
            ...
            className="mb-0 font-[500] text-[10px] md:text-[14px] text-[#888888]"
          >
          ...
          <FiTrash
            ...
            className="cursor-pointer w-[12px] md:w-[24px]"
          />
        </div>
      </div>
    </>
